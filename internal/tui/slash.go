...
func slashCatalog() []slashCommand {
	return []slashCommand{
		...
		{Name: "/fork", Description: "fork current, selected, or latest saved session at its committed turn", NeedsArg: true},
...
func helpText() string {
	return strings.Join([]string{
		...
		"  /fork [id|name|--last]  fork current, selected, or newest saved session at its latest committed turn (auto child ID)",
