...
func slashCatalog() []slashCommand {
	return []slashCommand{
		...
		{Name: "/resume", Description: "choose, resume, or use --last for a saved session ([--recover] after confirming prior process stopped)", NeedsArg: true},
...
func helpText() string {
	return strings.Join([]string{
		...
		"  /resume [id|--last] [--recover]  choose a saved session, resume by ID, or switch to newest; explicitly recover an interrupted operation",
