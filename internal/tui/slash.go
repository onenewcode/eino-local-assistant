...
func slashCatalog() []slashCommand {
	return []slashCommand{
		...
		{Name: "/resume", Description: "choose or resume a saved session ([--recover] after confirming prior process stopped)", NeedsArg: true},
...
func helpText() string {
	return strings.Join([]string{
		...
		"  /resume [id] [--recover]  choose a saved session, or resume by ID; explicitly recover an interrupted operation",
