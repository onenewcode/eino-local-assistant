...
func slashCatalog() []slashCommand {
	return []slashCommand{
		...
		{Name: "/agents", Description: "list queued/running agents, inspect, append, or cancel", NeedsArg: true},
...
func helpText() string {
	return strings.Join([]string{
		...
		"  /agents [show <id>|append <id>|cancel <id>]  list queued/running agents, inspect, draft, or cancel them",
