...
func slashCatalog() []slashCommand {
	return []slashCommand{
		...
		{Name: "/agents", Description: "list, show, append, or cancel background analysis agents", NeedsArg: true},
...
func helpText() string {
	return strings.Join([]string{
		...
		"  /agents [show <id>|append <id>|cancel <id>]  list, inspect, draft, or cancel process-local background agents",
